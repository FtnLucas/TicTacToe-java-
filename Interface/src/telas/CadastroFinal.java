 ...
 * @author IFPB
 */
public class CadastroFinal extends javax.swing.JDialog {

    /**
     * Creates new form CadastroFinal
     */
    public CadastroFinal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        csenhaCadastro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                csenhaCadastroActionPerformed(evt);
            }
        });
    ...
    private void csenhaCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_csenhaCadastroActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_csenhaCadastroActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ("".equals(senhavar) || "".equals(confirmar) || "".equals(usuarioCadastro)) {
            JOptionPane.showMessageDialog(null, "Campo(s) em Branco !");
        } else if ((senhavar == null ? confirmar == null : senhavar.equals(confirmar)) && !"".equals(senhavar)) {
            boolean verificacao = Central.cadastrar(Central.criarJogador(nomeCadastrado, senhavar));
            if (verificacao == true) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroFinal dialog = new CadastroFinal(new javax.swing.JFrame(), true);
