...
public class Central {
    ...
    public static boolean login2(String login, String senha) {
        /*System.out.print("Nome de usuário: ");
         String login = leitor.nextLine();
         System.out.print("Senha: ");
         String senha = leitor.nextLine();*/
    ...
    public static void login(JTextField login, JPasswordField senha) {
    ...
    public static void editar(String nusuario, String senhavar) {
        getJogador1().setLogin(nusuario);
        getJogador1().setSenha(senhavar);
        BancoDeDados.gerarArquivo(Central.jogadores);
    }
}
